...
@section('title', config('app.name') . '| 障害詳細')
<div class="container">
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th>原因種別</th>
                            <td>{{ !empty($trouble->cause_type) ? config('const.trouble.cause_type')[$trouble->cause_type] : '' }}
                            </td>
                        </tr>
                        <tr>
                            <th>原因工程</th>
                            <td>{{ !empty($trouble->cause_process) ? config('const.trouble.cause_process')[$trouble->cause_process] : '' }}
                            </td>
                        </tr>
                        <tr>
                            <th>担当者</th>
                        ...
                        <tr>
                            <th>作成日時</th>
                            <td>{{ !empty($trouble->created_at) ? \Carbon\Carbon::parse($trouble->created_at)->format('Y年m月d日') : '' }}
                            </td>
                        </tr>
                        <tr>
                            <th>更新日時</th>
                            <td>{{ !empty($trouble->created_at) ? \Carbon\Carbon::parse($trouble->updated_at)->format('Y年m月d日') : '' }}
                            </td>
                        </tr>
                    </tbody>
                </table>
                <div class="d-flex justify-content-between mb-4">
                    <div class="text-center col-md-6 mb-3">
                        <a href="{{ route('admin.trouble.edit.input', ['id' => $trouble->id]) }}"><button type="submit"
                                class="btn btn-primary">編集する</button></a>
                    </div>
                    <div class="text-center col-md-6 mb-3">
                        <a href="{{ route('admin.trouble.index') }}"><button type="submit"
